...
describe 'rvm::system' do
  ...
  context "with gnupg", :compile do
    ...
    it { should contain_gnupg_key('rvm_7D2BAF1CF37B13E2069D6956105BD0E739499BDB').with_key_id('7D2BAF1CF37B13E2069D6956105BD0E739499BDB').with_key_server('hkp://hkps.pool.sks-keyservers.net') }
  end
